...
#ifndef __MESOS_DOCKER_BACKEND__
#define __MESOS_DOCKER_BACKEND__
...
public:
  ...
  virtual process::Future<bool> destroy(const std::string& directory) = 0;
};
...
public:
  ...
  virtual process::Future<bool> destroy(const std::string& directory);
...
public:
  ...
  process::Future<bool> destroy(const std::string& directory);
...
#endif // __MESOS_DOCKER_BACKEND__
